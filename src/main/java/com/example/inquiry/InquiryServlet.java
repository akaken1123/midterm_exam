...
IOException { 
    ...
    if (action != null && action.equals("complete")) { 
      ...
      String content = req.getParameter("content");      String captchaInput = req.getParameter("captcha"); 
...
File.separator + UPLOAD_DIRECTORY; 
      ...
      if (!errors.isEmpty()) { 
        ...
        generateCaptcha(req);        RequestDispatcher rd = req.getRequestDispatcher("/index.jsp"); 
        rd.forward(req, resp); 
      } else { 
